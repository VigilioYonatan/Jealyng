...
<div class='success-container2'>
    ...
    <a download="facturaDePago" class="btn about-info__btn"
        href="./build/pdf/<?= $_SESSION['dataorden']['nombrePDF'] ?>">Descargar
        PDf</a>
...
<?php
$email = new EmailClass($usuario['email_user'], $usuario['nick_user'], $_SESSION['dataorden']['nombrePDF']);
$email->enviarFacura();
$_SESSION['dataorden'] = [];
?>
