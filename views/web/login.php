...
<section class="container">
    <div class="formulario">
        <form action="" class="form" id="formulario">
            ...
            <div class="form-link">
                <a class="form-link__link" href="/registrar">No tengo una cuenta?</a>
                <a class="form-link__link" id="olvideContraseña" href="">Olvidé mi contraseña</a>
            </div>
        </form>
...
<script src="./build/js/web/formulario/login.js"></script>
<script src="./build/js/web/formulario/recuperar.js"></script>